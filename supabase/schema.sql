...
INSERT INTO site_settings (key, value) VALUES
  ...
  ('whatsapp_link', 'https://wa.me/34680957096'),
...
CREATE TRIGGER update_culinary_experiences_updated_at BEFORE UPDATE ON culinary_experiences FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TRIGGER update_booking_availability_updated_at BEFORE UPDATE ON booking_availability FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
