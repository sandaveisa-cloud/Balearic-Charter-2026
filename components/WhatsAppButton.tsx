...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 left-8 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#20BA5A] transition-all duration-300 hover:scale-110 group"
      aria-label="Contact us on WhatsApp"
    >
      {/* Pulse ring animation - only on hover */}
      <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-0 group-hover:opacity-75 group-hover:animate-ping transition-opacity duration-300"></span>
