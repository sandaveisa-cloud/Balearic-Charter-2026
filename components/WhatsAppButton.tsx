...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span 
        className={`hidden md:block text-sm font-medium text-white bg-[#1e3a5f] px-4 py-2 rounded-full shadow-lg transition-all duration-300 ${
      ...
      <div className="relative flex items-center justify-center w-14 h-14 bg-[#1e3a5f] text-white rounded-full shadow-lg hover:bg-[#c9a227] transition-all duration-300 hover:scale-105">
        {/* Subtle ring on hover */}
        <span className="absolute inset-0 rounded-full border-2 border-[#c9a227] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
