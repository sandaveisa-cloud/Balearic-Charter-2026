            ...
            >
              ...
              <div className="space-y-3">
                ...
                <a
                  ...
                  className="flex items-center gap-3 w-full px-4 py-4 md:py-5 bg-luxury-blue text-white rounded-lg hover:bg-luxury-gold hover:text-luxury-blue transition-all duration-300 font-semibold group text-base md:text-lg"
                >
                  <Phone className="w-5 h-5 md:w-6 md:h-6 group-hover:scale-110 transition-transform flex-shrink-0" />
                ...
                <a
                  ...
                  className="flex items-center gap-3 w-full px-4 py-4 md:py-5 bg-gray-100 text-luxury-blue rounded-lg hover:bg-luxury-gold hover:text-white transition-all duration-300 font-semibold group text-base md:text-lg"
                >
                  <Mail className="w-5 h-5 md:w-6 md:h-6 group-hover:scale-110 transition-transform flex-shrink-0" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 w-full px-4 py-4 md:py-5 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-all duration-300 font-semibold group text-base md:text-lg"
                >
                  <MessageCircle className="w-5 h-5 md:w-6 md:h-6 group-hover:scale-110 transition-transform flex-shrink-0" />
                  <span className="flex-grow text-left">{t('whatsapp') || 'WhatsApp'}</span>
                </a>
              </div>
            </div>
