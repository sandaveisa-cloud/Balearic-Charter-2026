            ...
            <ul className="space-y-2 text-gray-300">
              {settings.contact_locations && (
                <li className="flex items-start gap-2">
                  <svg className="w-4 h-4 mt-1 flex-shrink-0 text-luxury-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <span>{settings.contact_locations}</span>
                </li>
              )}
              {settings.contact_phone && (
                <li>
                  <a href={`tel:${settings.contact_phone.replace(/\s/g, '')}`} className="hover:text-luxury-gold transition-colors flex items-center gap-2">
