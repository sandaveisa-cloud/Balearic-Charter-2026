          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              {settings.contact_phone && (
                <li>
                  <a href={`tel:${settings.contact_phone}`} className="hover:text-luxury-gold transition-colors">
                    {settings.contact_phone}
                  </a>
                </li>
              )}
              {settings.contact_email && (
                <li>
                  <a href={`mailto:${settings.contact_email}`} className="hover:text-luxury-gold transition-colors">
                    {settings.contact_email}
                  </a>
                </li>
              )}
