...
export default function OptimizedImage({
  ...
  // Validate src prop - reject null, undefined, or invalid values
  if (!src || typeof src !== 'string' || src.trim() === '') {
    console.warn('[OptimizedImage] Invalid src prop:', src)
    return (
      <div
      ...
      >
        <div className="text-center text-gray-500 p-4">
          ...
          <p className="text-xs mt-1 opacity-75">Invalid image source</p>
        </div>
      </div>
    )
  }
  ...
  // Error placeholder - improved fallback
  if (hasError) {
    return (
      <div
        className="bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center"
      ...
      >
        <div className="text-center text-gray-500 p-4">
          ...
          <p className="text-sm font-medium">Image unavailable</p>
          <p className="text-xs mt-1 opacity-75">Please check image URL</p>
        </div>
      </div>
    )
  }
